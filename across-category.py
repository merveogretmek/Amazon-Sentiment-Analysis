...
# read data from csv
train_dataframe = pd.read_csv("Data/office_products.csv")
test_dataframe = pd.read_csv("Data/office_products.csv")

train_data = train_dataframe.head(80000)
test_data = test_dataframe.tail(20000)
...
df2.to_csv("word_coef_across_category.csv", index=False, encoding="utf-8")
